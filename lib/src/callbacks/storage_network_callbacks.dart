  ...
  StorageNetworkCallbacks copyWith({
    ...
    OnFetchCallback<T> onFetch,
      ...
      _InlineStorageNetworkCallbacks<T>(
        ...
        onUpdate: this.onUpdate ?? onUpdate,
        onFetch: this.onFetch ?? onFetch,
      );
...
class _InlineStorageNetworkCallbacks<T> extends StorageNetworkCallbacks<T> {
  ...
  @override
  Future<T> onCreate(T element) => _onCreate?.call(element);

  @override
  Future<void> onDelete(T element) => _onDelete?.call(element);
